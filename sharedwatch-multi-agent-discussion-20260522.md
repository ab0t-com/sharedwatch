...
Related prior work:
- `sharedwatch-engineering-report-20260520_015418.md` — engineering map
- `sharedwatch-pmm-report-20260520_015418.md` — positioning
- `sharedwatch-agent-fit-20260520_034245.md` — the multi-agent fit analysis
- `tickets/ticket-agent-event-access-20260520_035113.md` — SW-AGENT-1 (events query surface) — landed
- `tickets/ticket-multi-folder-watching-20260520_101921.md` — SW-AGENT-3 (multi-folder) — open
...
**Short answer: no new table. Three new columns + four new indexes + per-root correctness invariants.** The detailed plan is already in `tickets/ticket-multi-folder-watching-20260520_101921.md` (SW-AGENT-3). Highlights below for the discussion:
